...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { im_id: @score.im_id, im_type: @score.im_type, ip: @score.ip, item_id: @score.item_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { im_id: @score.im_id, im_type: @score.im_type, ip: @score.ip, item_id: @score.item_id }
    assert_redirected_to score_path(assigns(:score))
  end
